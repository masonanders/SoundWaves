...
export const play = () => dispatch => dispatch({ type: PLYAER_PLAY });

export const pause = () => dispatch => dispatch({ type: PLYAER_PAUSE });

export const stop = () => dispatch => dispatch({ type: PLAYER_STOP });
